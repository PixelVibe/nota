...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/extensionPage/extensionpage.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/extensionPage/extensionpage.js":
/*!********************************************!*\
  !*** ./src/extensionPage/extensionpage.js ***!
  \********************************************/
/*! no exports provided */
...
class NotesListFull extends preact__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor() {
    super();
    this.state.notes;
      ...
      if (state.notes.hasOwnProperty(key)) {
        ...
        a.push(Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("ul", null, state.notes[key].notes.map((note, index) => {
          return Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("li", {
            ...
            onClick: e => deleteNote(index, key, e)
  ...
  render(_props, state) {
    return Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, this.renderNoteGroups(state));
  }
...
/******/ });
//# sourceMappingURL=extensionpage.js.map